...
> # 🌐 BiliTool-ZH · 中文汉化版
>
> 本仓库是 [RayWangQvQ/BiliBiliToolPro](https://github.com/RayWangQvQ/BiliBiliToolPro) 的 **Web 界面中文化分支**，
> 在原作者基础上进行了 **Web 管理界面简体中文汉化 + B 站粉色风格 UI 美化**，零功能改动。
>
> - 🔤 汉化范围：导航菜单、登录页、任务调度表、任务名、触发器类型、历史/日志弹窗、错误页等
> - 🎨 UI 升级：B 站主题色（#FB7299）侧边栏、品牌化登录页、仪表盘首页
> - 🤖 本汉化由 **Hermes Agent**（Nous Research 出品的开源 AI 智能体）协助完成，主模型：**DeepSeek-V4-Flash**
> - 📜 遵循 **GPL-3.0** 协议，保留原作者版权：**RayWangQvQ** → https://github.com/RayWangQvQ/BiliBiliToolPro
> - 🚀 构建部署方式与原版一致，详见下方文档或 [汉化说明 README_ZH.md](README_ZH.md)
